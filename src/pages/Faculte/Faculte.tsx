        ...
        <div className="row g-4">
          <div className="col-md-4 research-card">
            <div className="card h-100">
              ...
              <img src="https://img.freepik.com/free-photo/robot-handshake-human-background-futuristic-digital-age_53876-129770.jpg" className="card-img-top" alt="Sciences" />
              <div className="card-body">
                <span className="badge research-badge mb-3">15 Laboratoires</span>
                <p className="card-text">Recherche de pointe en intelligence artificielle, nanotechnologies et énergies renouvelables.</p>
          ...
          <div className="col-md-4 research-card">
            <div className="card h-100">
              ...
              <img src="https://img.freepik.com/free-photo/scientist-working-laboratory_23-2148980276.jpg" className="card-img-top" alt="Santé" />
              <div className="card-body">
                <span className="badge research-badge mb-3">8 Centres d'excellence</span>
                <p className="card-text">Recherche translationnelle en oncologie, neurosciences et médecine régénérative.</p>
                <ul className="list-unstyled">
          ...
          <div className="col-md-4 research-card">
            <div className="card h-100">
              ...
              <img src="https://img.freepik.com/free-photo/group-diverse-people-having-business-meeting_53876-25060.jpg" className="card-img-top" alt="SHS" />
              <div className="card-body">
                <span className="badge research-badge mb-3">6 Chaires UNESCO</span>
                <p className="card-text">Études interdisciplinaires sur les sociétés contemporaines et les patrimoines culturels.</p>
                <ul className="list-unstyled">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="pub-item">
              ...
              <p>Découverte de nouveaux matériaux supraconducteurs fonctionnant à des températures record, ouvrant la voie à des applications énergétiques révolutionnaires.</p>
            ...
            <div className="pub-item">
              ...
              <p>Analyse transnationale des effets redistributifs des politiques climatiques dans 45 pays, avec recommandations pour des transitions justes.</p>
              <a href="#" className="btn btn-sm btn-outline-primary">Lire l'article</a>
            </div>
            <div className="pub-item">
              ...
              <p>Identification d'un nouveau mécanisme moléculaire impliqué dans la résistance aux traitements, ouvrant des perspectives pour de nouvelles thérapies.</p>
              <a href="#" className="btn btn-sm btn-outline-primary">Lire l'article</a>
            </div>
    ...
    <footer>
      <div className="container">
        ...
        <div className="copyright">
          <p className="mb-0">© 2023 Institut - Tous droits réservés | <a href="#">Mentions légales</a> | <a href="#">Politique de confidentialité</a></p>
        </div>
      </div>
    </footer>
  </>
